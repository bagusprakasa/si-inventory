    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-6">
                ...
                <h1 class="mb-0 fw-bold">Guide Driver</h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-md-flex">
                            <div>
                                <a href="{{ route('guide-driver.create') }}" class="btn btn-primary">Tambah Data</a>
                            </div>
                            <div class="ms-auto">
                            ...
                            <table class="table mb-0 table-hover align-middle text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">Guide Driver</th>
                                    ...
                                    @if (count($data) != 0)
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->type }}</td>
                                                <td>
                                                    <a href="{{ route('guide-driver.edit', $item->id) }}"
                                                    ...
                                                    <form action="{{ route('guide-driver.destroy', $item->id) }}" method="post"
                                                        id="delete">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
